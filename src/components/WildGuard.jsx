...
import { Camera, Upload, Users, MapPin, Phone, User, Shield } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background">
            ...
            <Card className="p-6">
              ...
              <div className="space-y-4">
                ...
                <Button 
                  ...
                  disabled={isSubmitting || !formData.fullName || formData.phoneNumber.length !== 10 || formData.pincode.length !== 6}
                  ...
                  users.map((user) => (
                    <div key={user.id} className="border-b border-gray-100 pb-4 last:border-b-0">
                      <div className="space-y-1">
                        ...
                        <p className="text-xs text-gray-500">Registered: {user.timestamp}</p>
                      </div>
                    </div>
                  ))
                )}
              ...
              <div className="space-y-4">
                {imagePreview ? (
                  <div className="space-y-4">
                    ...
                    <p className="text-sm text-gray-600 text-center">Image ready for processing</p>
                  </div>
                ) : (
      ...
      <footer className="mt-auto py-4 text-center border-t border-gray-200">
        <p className="text-sm text-gray-500">WildGuard - Wildlife Conflict Alert System</p>
      </footer>
    </div>
  );
};
